...
enum COMMAND
{
    ...
    QSB_LOCK_CMD,
    QSB_OVERRIDE_LOCK_CMD,
    QSB_CANCEL_LOCK_CMD,
    QSB_UNLOCK_CMD,
    QSB_TRANSFER_ADMIN_CMD,
    QSB_EDIT_ORACLE_THRESHOLD_CMD,
    QSB_ADD_ROLE_CMD,
    QSB_REMOVE_ROLE_CMD,
    QSB_PAUSE_CMD,
    QSB_UNPAUSE_CMD,
    QSB_EDIT_FEE_PARAMETERS_CMD,
    QSB_GET_CONFIG_CMD,
    QSB_IS_ORACLE_CMD,
    QSB_IS_PAUSER_CMD,
    QSB_GET_LOCKED_ORDER_CMD,
    QSB_IS_ORDER_FILLED_CMD,
    QSB_COMPUTE_ORDER_HASH_CMD,
    QSB_GET_ORACLES_CMD,
    QSB_GET_PAUSERS_CMD,
    QSB_GET_LOCKED_ORDERS_CMD,
    QSB_GET_FILLED_ORDERS_CMD,
